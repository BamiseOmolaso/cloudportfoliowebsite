...
export default function AdminLayoutClient({
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex">
      <div
        className={`hidden lg:block ${isCollapsed ? "lg:w-20" : "lg:w-64"} lg:flex-shrink-0 fixed h-screen transition-all duration-300 z-50`}
      >
      ...
      <div
        className={`flex-1 ${isCollapsed ? "lg:pl-20" : "lg:pl-64"} transition-all duration-300 relative`}
      >
